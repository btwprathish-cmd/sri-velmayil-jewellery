...
export const metadata = getSeoMetadata({
  ...
  description: "Sri Velmayil Jewellery is a trusted jewellery store in Tirupur offering gold jewellery, wedding collections, daily gold rates, and BIS hallmarked products.",
  path: "/"
});
...
export default async function HomePage() {
  ...
  return (
    <>
      {/* Inject JewelryStore Schema Markup */}
              ...
              <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
                <div className="inline-flex items-center space-x-2 bg-[#D4AF37]/10 px-3 py-1.5 rounded-full border border-[#D4AF37]/20">
                  ...
                  <span className="text-xs font-bold text-[#D4AF37] uppercase tracking-widest">
                    100% BIS 916 Hallmarked Jewellery
                  </span>
                </div>
                ...
                <div className="bg-[#1a0b2e]/80 border border-[#D4AF37]/25 rounded-2xl p-6 sm:p-8 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center bg-[#0c0418]/60 p-4 rounded-xl border border-[#D4AF37]/10">
                      <div>
                        <span className="font-sans font-bold text-lg text-white">22K Gold (916)</span>
                        <p className="text-xs text-[#F3E5AB]/60">Ideal for ornaments</p>
                      </div>
                    ...
                    <div className="flex justify-between items-center bg-[#0c0418]/60 p-4 rounded-xl border border-[#D4AF37]/10">
                      <div>
                        <span className="font-sans font-bold text-lg text-white">22K Gold (Sovereign)</span>
                        <p className="text-xs text-[#F3E5AB]/60">8 Gram Board Rate</p>
                      </div>
                      <div className="text-right">
                        <span className="font-serif text-2xl font-bold text-[#D4AF37] font-mono">
                          ₹{latestRate.gold22k_8g.toLocaleString("en-IN")}
                        </span>
                        <p className="text-[10px] text-[#F3E5AB]/50">Per 8 Grams</p>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center bg-[#0c0418]/60 p-4 rounded-xl border border-[#D4AF37]/10">
                      <div>
                        <span className="font-sans font-bold text-lg text-white">Fine Silver</span>
                        <p className="text-xs text-[#F3E5AB]/60">Purity 99.9%</p>
                      </div>
                      <div className="text-right">
                        <span className="font-serif text-2xl font-bold text-[#D4AF37] font-mono">
        ...
        <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            ...
            <p className="text-sm sm:text-base text-[#F3E5AB]/70 font-sans">
              Hand-crafted masterpieces reflecting Tamil Nadu's legacy. Hallmarked with trust, detailed for beauty.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-sm text-[#F3E5AB]/75 leading-relaxed max-w-sm">
                  We guarantee 100% purity. Every gold item features the standard BIS triangle, purity rating, and HUID registry numbers.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-sm text-[#F3E5AB]/75 leading-relaxed max-w-sm">
                  From traditional Tamil heritage bridal designs to light-weight modern jewellery, our master artisans craft each piece to perfection.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-sm text-[#F3E5AB]/75 leading-relaxed max-w-sm">
                  Serving families in Tirupur with honesty and transaprency. Our pricing lists separate gold value, making charges, and GST clearly.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-sm sm:text-base text-[#F3E5AB]/75 font-sans leading-relaxed">
                  Experience the purity of our jewellery in person. Our friendly showroom consultants will guide you to find the perfect ornaments for weddings, gifts, or investment portfolios.
                </p>
                ...
                <div className="space-y-4 font-sans text-sm sm:text-base">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-[#F3E5AB]/70">Sri Velmayil Jewellery, 89 New Market Street, Tirupur, Tamil Nadu 641604</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-[#F3E5AB]/70">
                        <a href="tel:+919443476183" className="hover:text-[#D4AF37] hover:underline">
                          +91 9443476183
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-[#F3E5AB]/70">Monday - Sunday: 9:30 AM - 9:00 PM</p>
                    </div>
                  </div>
                </div>
