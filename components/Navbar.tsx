        ...
        <div className="md:hidden bg-[#1a0b2e] border-b border-[#D4AF37]/20 transition-all duration-300">
          <div className="px-2 pt-2 pb-4 space-y-1 sm:px-3">
            ...
            <div className="pt-4 px-3">
              <a
                href="tel:+919443476183"
                className="w-full flex justify-center items-center py-3 border border-[#D4AF37] text-base font-bold rounded-md text-[#D4AF37] bg-transparent active:bg-[#D4AF37] active:text-[#1a0b2e]"
              >
                Call: +91 9443476183
              </a>
            </div>
