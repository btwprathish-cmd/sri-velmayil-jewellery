    ...
    <div className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        ...
        <p className="mt-3 text-sm sm:text-base text-[#F3E5AB]/70 max-w-2xl mx-auto font-sans">
          Explore our curated, hand-crafted gold designs. From light-weight daily wear items to heavy traditional Tamil bridal ornaments.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {collectionsData.map((category) => (
          <div key={category.id} className="group bg-[#1a0b2e]/40 border border-[#D4AF37]/15 rounded-2xl overflow-hidden hover:border-[#D4AF37]/45 transition-all duration-300 flex flex-col justify-between shadow-xl">
            ...
            <div className="p-6 flex-grow flex flex-col justify-between space-y-4">
              <div>
                ...
                <p className="text-sm text-[#F3E5AB]/65 leading-relaxed font-sans mt-2">{category.description}</p>
                <p className="text-xs text-[#D4AF37]/80 font-bold uppercase tracking-wider mt-3">Available Items: {category.items.length} designs</p>
              </div>
              <div className="pt-4 border-t border-[#D4AF37]/10">
                <Link href={`/jewellery-collections/${category.slug}`}
