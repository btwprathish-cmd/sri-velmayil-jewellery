...
export default function FAQ({ showCTA = true }: FAQProps) {
  return (
    <div className="py-16 sm:py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h2 className="font-serif text-3xl sm:text-4xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F3E5AB]">
      ...
      {showCTA && (
        <div className="mt-12 text-center bg-[#1a0b2e]/20 border border-[#D4AF37]/10 p-8 rounded-2xl">
