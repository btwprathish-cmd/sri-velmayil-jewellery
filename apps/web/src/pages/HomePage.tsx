            ...
            {metalsList.map((metal) => {
              ...
              return (
                <Link
                  ...
                  className={`group relative rounded-2xl overflow-hidden border border-${ThemeClass} hover:border-${ThemeHoverClass} transition-all duration-300 shadow-xl flex flex-col`}
